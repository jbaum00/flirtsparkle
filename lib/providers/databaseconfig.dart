...
class DataBaseConfig {
  ...
  static Future<void> createChatHistoryTable(String profile) async {
    final data = await JsonConnector.readJsonChat(profile);
    ...
    for (var entry in data) {
      await database.insert(
          tableName,
          {
            'id': entry['id'],
            'text': entry['msg']['text'],
            'text2': entry['msg']['text2'],
            'text3': entry['msg']['text3'],
            'status': entry['status'],
            'answer': entry['answeroption']['answer'],
            'answer2': entry['answeroption']['answer2'],
            'answer3': entry['answeroption']['answer3'],
          },
          conflictAlgorithm: sql.ConflictAlgorithm.replace);
    }
  }*/
